...
For example, the {Cecil::Lang::TypeScript `Cecil::Lang::TypeScript`} subclass
defines several {Cecil::Lang::TypeScript::Helpers helper methods} for generating TypeScript code.
